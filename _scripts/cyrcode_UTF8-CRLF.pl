#!/usr/bin/perl
## NOTE: Lines 2-to-46 (inclusive) were extra added (so as to provide hyperlinks
...
## NOTE2: For compatibility reasons, you may need to search&replace all
## occurences of '\n' (LF) (Unix newline) in the code with '\r\n' (CRLF) if you 
## run this script under MS Windows...
##
