...
`ve4ernik2@gmail.com` (alternative email if the inbox of the main email gets filled&thus emails are auto-rejected/not-received: `ikurdov10@gmail.com`)
...
* Cryptocurrencies (but the above is preferred!):
...
All these 'problematic' files from 3rd-parties will eventually be listed in the file [CREDITS_FAIR-USE.txt](https://github.com/sahwar/Bulogos/blob/master/CREDITS_FAIR-USE.txt).
