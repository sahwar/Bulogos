...
| --- | --- | --- | --- | --- |
| bg-bds **?** | `BG` български (България) - български | БДС, т.е. БДС 5237:1978 **?** | ... |
...
| bg-bds-ex | _Стандартна подредба по БДС 5237:1978 (разширена)_ | TO-ADD to MS Windows7/8/8.1/10: _bg_bds_ex.zip_ (визуализация: keyboard_layouts.pdf) | ... | ... |
| bg-phon-ex | _Традиционна фонетична подредба (разширена)_ | TO-ADD to MS Windows7/8/8.1/10: _bg_phon_ex.zip_ (визуализация: keyboard_layouts.pdf) | ... | ... |
---------------------------------------------------------
