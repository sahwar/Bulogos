...
**БЕЛЕЖКА3:** При всички от гореизброените 6 стила е СИЛНО ПРЕПОРЪЧИТЕЛНО в непоказваните коментари в изходния код на езиковия пакет, преведен според съответния стил, да се включва клеймо/щемпел с датата и часа на последна промяна на файла (datetime stamp), както и името (и/или псевдонима) (на български, или на английски, или и на двата езика) и личния имейл на ВСИЧКИ преводачи, участвали в превода (допринесли за него). По желание, може да се добави дори и HTTP хипервръзка (URI/URL) към хранилище, от което може да се изтеглят всички version-controlled версии на преводния езиков пакет, а защо не - и официалния уебсайт на програмата (ако той вече не е включен в менютата на самата програма).
