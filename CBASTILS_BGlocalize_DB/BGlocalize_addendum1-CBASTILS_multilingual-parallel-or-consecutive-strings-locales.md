...
11.2.
двуезични onmouseover/on-clocktime-delay-every-x-seconds текстови низове в ToolTips **_ИЛИ_** преводни onmouseover/on-clocktime-delay-every-x-seconds текстови низове
