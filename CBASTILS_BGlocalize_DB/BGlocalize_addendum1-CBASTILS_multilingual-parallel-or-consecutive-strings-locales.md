...
0) Основните начини за превод на менютата от интерфейса на компютърни програми (взети са от BGlocalize, текстовете на Антон Зиновиев и ръководствата на бившето „Сдружение за свободен софтуер“):

| --- | --- | --- | --- | --- |
| Превод чрез 2 л. ед. ч. (повелителна/заповедна/императивна форма) | Превод чрез 2 л. мн. ч. (повелителна/заповедна/императивна форма) | Превод предимно чрез съществителни имена, особено с отглаголни съществителни на „-не“ и „-ние“ | Смесен стил № 1 (някои от първите 3-ти стила) | Смесен стил № 2 (като смесен стил № 1, но и с използване на някои от долните 14 варианта за превод) |

**БЕЛЕЖКА:** Обърнете внимание, че ВСЕКИ преводач превежда по свои си начин(и) текстовите низове от интерфейса на компютърните програми (това се дължи на различията между хората, както и различното им образование и езикови квалификации/умения, т.е. на различните им (но в същността си фундаментално подобни, тъй като всички сме хора) генотип+фенотип, автобиографии, идиосинкразии и идиолекти (идиолект = индивидуалните уникални характеристики на речта/езика на всеки човек). Точно затова бяха измислени гореизброените специализирани ръководства (упътвания) и речници (глосари, glossaries) с български преводи на специализираните термини (с цел донякъде уеднаквяването на превода на основните термини), като дори при тях се включват поне **няколко варианта за превод** (и дори със ~зачеркнат~ стил на форматирането се включват не толкова популярни или препоръчвани преводи!).
