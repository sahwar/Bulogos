...
текстово форматирани такива преводни низове... Но няма как да се избегне това, както е и за мързела, демотивацията и остаряването... :P Сътрудничество, inclusionism, компромиси и incremental improvements/updates са му майката... 😁
